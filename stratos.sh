...
if [ ! $stratos_nodename ]; then
	...
	echo -e '\e[0m'
	curl -s https://raw.githubusercontent.com/SecorD0/utils/main/insert_variable.sh | bash -s "stratos_nodename" $stratos_nodename
else
...
echo -e 'You can use \e[40m\e[92m$stratos_nodename\e[0m and \e[40m\e[92m$stratos_address\e[0m variables (start to print variable then press "Tab")\n\n'
